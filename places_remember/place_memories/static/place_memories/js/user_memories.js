function get_user_memories(link, page=0) {
    ...
    if (page > 0) {
        ...
        // Get selected sorting order
        params.set("ordering", document.getElementById("ordering").value);
        // Get search string
        const input_ele = document.getElementById("memory-search-input");
        if (input_ele.value)
            params.set("search", input_ele.value);
    }
